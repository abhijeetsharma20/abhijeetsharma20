...
<!-- Animated Header -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:6C63FF,100:00D4FF&height=200&section=header&text=Abhijeet%20Sharma&fontSize=60&fontColor=ffffff&fontAlignY=38&desc=FullStack%20.NET%20Developer%20%7C%20GenAI%20Enthusiast&descSize=18&descAlignY=58&animation=fadeIn" width="100%"/>

<!-- Typing SVG -->
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=6C63FF&center=true&vCenter=true&width=600&lines=Building+robust+apps+with+.NET+Core;Crafting+cross-platform+magic+with+MAUI;Exploring+the+frontier+of+GenAI;Turning+coffee+into+clean+code+%E2%98%95)](https://git.io/typing-svg)
...
```csharp
var abhijeet = new Developer
{
    Name       = "Abhijeet Sharma",
    Role       = "FullStack .NET Developer & GenAI Enthusiast",
    Stack      = new[] { ".NET Core", ".NET MAUI", "Python" },
    Passion    = "Building intelligent, cross-platform experiences",
    CurrentFocus = "Merging enterprise-grade .NET apps with GenAI capabilities",
    FunFact    = "I debug in production and feel no guilt 😅"
};
```
...
- 🔭 Integrating **LLMs & RAG pipelines** into .NET applications
- 🌐 Building **cross-platform apps** with .NET MAUI
- 🧪 Experimenting with **AI Agents** and agentic workflows in Python
- 📖 Deep-diving into **Azure AI Services** and Semantic Kernel

---

## 💡 My Philosophy

> *"Great software isn't just code — it's the bridge between a problem and the person who has it."*
